...
def _explain_tree_model(
    ...
    if not feature_cols:
        ...
        exclude = {'race_id', 'driver_id', 'team', 'season', 'round', 'track_id',
                   'finish_position', 'dnf', 'points_earned'}
...
def _explain_linear_ensemble(
    ...
    try:
        ...
        result = permutation_importance(
            model, X_race, y_race, n_repeats=10, random_state=42
        )
