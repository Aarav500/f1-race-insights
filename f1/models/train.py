...
def prepare_features(
    ...
    if feature_cols is None:
        ...
        exclude_cols = {
            'race_id', 'driver_id', 'team', 'season', 'round', 'track_id',
            'finish_position', 'dnf', 'points_earned', 'race_date', 'track_name',
            'track_country', 'race_name', 'country', 'driver_prior_races_count',
...
def main():
    ...
    parser.add_argument('--data', type=str, required=True,
                        help='Path to feature data (parquet or csv)')
    parser.add_argument('--output', type=str, default='models',
                        help='Output directory for models')
    parser.add_argument('--test-size', type=float, default=0.2,
                        help='Fraction of data for testing')
    parser.add_argument('--window', type=int, default=5,
                        help='Rolling window size (for metadata)')
    ...
    save_model_artifacts(
        model, args.model, args.task, feature_cols, metrics,
        output_dir, args.window, args.seed
    )
