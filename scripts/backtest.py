...
from f1.evaluation.backtest import WalkForwardBacktest, create_model_trainer, aggregate_results
...
def generate_markdown_report(
    ...
    if not df.empty:
        ...
        lines.append("- **Brier**: Mean squared error of probabilities (lower is better, range [0, 1])")
