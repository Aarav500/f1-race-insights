            ...
            <div className="bg-white rounded-lg shadow p-6 mb-12">
                ...
                <div className="space-y-6">
                    <ApiExample
                        ...
                        example={`curl "http://localhost:8000/api/f1/predict/race/2024_01?model=xgb"`}
                    />
                    ...
                    <ApiExample
                        ...
                        example={`curl "http://localhost:8000/api/f1/explain/race/2024_01?driver_id=VER&model=xgb"`}
                    />
                    ...
                    <ApiExample
                        ...
                        example={`curl -X POST "http://localhost:8000/api/f1/counterfactual?model=xgb" \\
