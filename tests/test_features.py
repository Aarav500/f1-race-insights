...
def test_rolling_features_use_only_prior_races():
    ...
    race_results['race_id'] = race_results['year'].astype(str) + '_' + race_results['round'].astype(str).str.zfill(2)
    ...
    assert ver_r2['driver_prior_races_count'] == 1, \
        "Second race should have exactly 1 prior race"
    assert ver_r2['driver_rolling_avg_finish'] == 1.0, \
        "VER's rolling avg should be 1.0 (finished 1st in race 1)"
    assert ver_r2['driver_rolling_avg_points'] == 25.0, \
        "VER's rolling avg points should be 25.0"
    ...
    assert ver_r3['driver_prior_races_count'] == 2, \
        "Third race should have exactly 2 prior races"
