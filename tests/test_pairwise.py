...
def test_no_leakage_rolling_features():
    ...
    race1 = pd.DataFrame([
        {
            'race_id': '2023_01', 'season': 2023, 'round': 1,
            'driver_id': 'D1', 'team': 'TeamA', 'finish_position': 1,
            'quali_position': 1, 'quali_delta_to_pole': 0.0,
        ...
        {
            'race_id': '2023_01', 'season': 2023, 'round': 1,
            'driver_id': 'D2', 'team': 'TeamB', 'finish_position': 2,
            'quali_position': 2, 'quali_delta_to_pole': 0.1,
    ...
    race2 = pd.DataFrame([
        {
            'race_id': '2023_02', 'season': 2023, 'round': 2,
            'driver_id': 'D1', 'team': 'TeamA', 'finish_position': 2,
            'quali_position': 1, 'quali_delta_to_pole': 0.0,
        ...
        {
            'race_id': '2023_02', 'season': 2023, 'round': 2,
            'driver_id': 'D2', 'team': 'TeamB', 'finish_position': 1,
            'quali_position': 2, 'quali_delta_to_pole': 0.1,
...
def test_dnf_handling():
    ...
    race_df = pd.DataFrame([
        ...
        {
            'race_id': '2023_01', 'season': 2023, 'round': 1,
            'driver_id': 'D2', 'team': 'TeamB', 'finish_position': np.nan,  # DNF
            'quali_position': 2, 'quali_delta_to_pole': 0.1,
